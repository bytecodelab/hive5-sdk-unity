...
namespace Hive5
{
	...
	public partial class Hive5Client : MonoSingleton<Hive5Client> {
		...
		* @apiExample Example usage:
		* Hive5Client hive5 = Hive5Client.Instance;
		* hive5.CreateGooglePurchase(productCode, PlatformType.Google, receiverPlatformUserId, mailForReceiver, callback);
		*/
		...
		* @apiExample Example usage:
		* Hive5Client hive5 = Hive5Client.Instance;
		* hive5.CreateApplePurchase(productCode, PlatformType.Google, receiverPlatformUserId, mailForReceiver, callback);
		*/
